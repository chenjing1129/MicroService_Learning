package top.cj.requestservice.crawler;
...
public class NewsCrawler {
    private static final String TARGET_URL = "https://news.ifeng.com";
        ...
        try (CloseableHttpClient httpClient = HttpClients.custom()
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpGet)) {
                ...
                if (entity != null) {
                    ...
                    Object[] titleNodes = rootNode.evaluateXPath("//*[@id=\"root\"]/div[5]/div[1]/div");
